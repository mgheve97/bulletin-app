  ...
  return (
    <div className="w-screen h-screen px-4 md:px-16 bg-green-100">
      <div className="flex flex-col">
        <nav className="flex justify-between pt-[133px] gap-2">
          <p className="font-bold text-5xl text-slate-700">
            CREATE A NEW ARTICLE
          </p>
          <div>
            <button
              className="font-bold text-slate-700 bg-white text-3xl px-4 py-2 border-2 border-green-700 rounded-md shadow-lg "
              onClick={GotoBoard}
            >
              View Board
            </button>
        ...
        <div className="flex justify-center items-center mt-16">
          <div className="">
            <div className="flex flex-col">
              <input
                className="border-b-2 border-green-700 w-[800px] text-lg p-3 rounded-md font-bold"
                placeholder="Title"
                type="text"
                id="title"
                name="title"
              ...
              <div className="mt-12">
                <textarea
                  className=" resize-y h-2/3 border-b-2 border-green-700 w-[800px] text-lg p-3 rounded-md font-bold"
                  placeholder="Content"
                  id="content"
                  name="content"
                  onChange={handleChange}
